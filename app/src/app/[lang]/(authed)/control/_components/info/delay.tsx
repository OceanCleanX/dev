...
const Delay = () => {
  ...
  const delay = socketData?.[0].delay;
    ...
    <>
      <svg
        className={cn(
          "size-5",
          "text-red-600",
          { "text-yellow-500": delay && delay < 100 },
          { "text-green-600": delay && delay < 50 },
        )}
